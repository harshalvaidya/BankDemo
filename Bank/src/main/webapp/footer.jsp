...
%>
	...
	<div id="footer">
		<span>Copyright &copy; 2014 <a href="http://www.m0interactive.com">m0 | interactive</a>. All rights reserved. Page loaded in <%=elapse_time %> seconds, using <%=QUERIES %> query(s)!</span>
